...
function getTimeGroup(dateString) {
  ...
  if (date >= sevenDaysAgo) return "最近 7 天"
  return "更早"
}
            ...
            <div className="max-h-[60vh] overflow-y-auto">
              ...
              {filteredConversations.length === 0 && query.trim() && (
                <div className="p-8 text-center">
                  ...
                  <div className="mt-4 text-lg font-medium text-zinc-900 dark:text-zinc-100">没有找到匹配的会话</div>
              ...
              {!query.trim() && conversations.length === 0 && (
                <div className="p-8 text-center">
                  <div className="text-lg font-medium text-zinc-900 dark:text-zinc-100">还没有任何会话</div>
                  <div className="mt-2 text-sm text-zinc-500 dark:text-zinc-400">新建一个对话后就可以开始使用</div>
                </div>
              )}
            </div>
          </motion.div>
